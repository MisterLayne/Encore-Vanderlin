/obj/effect/landmark/mapGenerator/domotan/field
	mapGeneratorType = /datum/mapGenerator/domotanfields
	endTurfX = 200
	endTurfY = 200
	startTurfX = 1
	startTurfY = 1
