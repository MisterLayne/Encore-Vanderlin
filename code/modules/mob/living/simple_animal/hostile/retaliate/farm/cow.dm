...
/mob/living/simple_animal/hostile/retaliate/cow
	...
	name = "moo-beast"
	desc = "The grail of many farmers. Commonfolk associate the motherly sow with Pomette, and the raging bull with Mordsol."
	icon_state = "cow"
	icon_living = "cow"
	icon_dead = "cow_dead"
	icon_gib = "cow_gib"
...
/mob/living/simple_animal/hostile/retaliate/bull
	icon = 'icons/roguetown/mob/monster/cow.dmi'
	name = "moo-beast bull"
	desc = "Rambunctious as the war-saint himself, a depiction of the moo-beast bull looms on the standard of the Aelondan city-state called Andalvia."
	icon_state = "bull"
	icon_living = "bull"
	icon_dead = "bull_dead"
	icon_gib = "bull_gib"
