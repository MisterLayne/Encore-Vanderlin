...
/datum/species/harpy
	...
	Harpies have been uplifted and reconnected to divinity by Pomette, having developed culture of music and song which caught the attention of such a goddess. \
	...
	Their serene songs and blissful music can be heard echoing far below, guiding travelers and thieves both to respite... or treasure. For as lifted into grace as they might be, these 'magpies' earn such a nickname from instinctual Deceiversan greed and love for anything that shines. \
