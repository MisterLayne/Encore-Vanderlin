/datum/action/cooldown/spell/projectile/pomette_curse
	...
	projectile_type = /obj/projectile/magic/pomette

/obj/projectile/magic/pomette
	name = "wine bubble"
	icon_state = "leaper"
	range = 7
...
/obj/projectile/magic/pomette/on_hit(atom/target, blocked = FALSE)
	. = ..()
	make_bubble()
	if(isliving(target))
		...
		L.apply_status_effect(/datum/status_effect/debuff/pomettedrunk)
		L.set_eye_blur_if_lower(40 SECONDS)

/obj/projectile/magic/pomette/on_range()
	. = ..()
	make_bubble()

/obj/projectile/magic/pomette/proc/make_bubble()
