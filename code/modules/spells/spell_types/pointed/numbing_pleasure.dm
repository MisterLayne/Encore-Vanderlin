...
/datum/action/cooldown/spell/painkiller/cast(mob/living/carbon/human/cast_on)
	...
	cast_on.apply_status_effect(/datum/status_effect/buff/lux_drank/baothavitae)					//Basically lowers fortune by 2 but +3 speed, it's powerful. Drugs cus Hertannea.
