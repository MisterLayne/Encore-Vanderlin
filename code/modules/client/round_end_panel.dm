...
/client/proc/show_round_stats(featured_stat)
	...
	data += "<font color='#2dc5bd'><span class='bold'>Thauma Revivals:</span></font> [GLOB.vanderlin_round_stats[STATS_LUX_REVIVALS]]<br>"
...
/client/proc/show_influences(debug = FALSE)
	...
	data += "Thauma harvested: [GLOB.vanderlin_round_stats[STATS_LUX_HARVESTED]] ([get_colored_influence_value(GLOB.vanderlin_round_stats[STATS_LUX_HARVESTED] * -50)])<br>"
