...
/mob/living/carbon/human/proc/vampire_conversion_prompt(mob/living/carbon/sire)
	...
	var/choice = tgui_alert(client_victim, "You have been offered the immortal blessing. Take it, or perish.", "THE CURSE OF KAIN", list("I ACCEPT", "TO VALDALA"), timeout = 15 SECONDS)
	if(QDELETED(src))
		return
	if(choice != "I ACCEPT")
