...
/obj/item/clothing/shirt/dress/maid/Initialize(mapload, ...)
	...
	AddComponent(
		...
		immune_jobs = list(/datum/job/prince, /datum/job/squire, /datum/job/advclass/pilgrim/noble, /datum/job/advclass/pilgrim/rare/qadirid, /datum/job/advclass/pilgrim/rare/grenzelhoft, /datum/job/advclass/pilgrim/rare/merchant), \
