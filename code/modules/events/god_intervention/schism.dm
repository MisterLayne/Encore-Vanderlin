...
/datum/round_event_control/schism_within_ten
	...
	allowed_storytellers = list(/datum/storyteller/akan, /datum/storyteller/mordsol, /datum/storyteller/necra, /datum/storyteller/iliope, /datum/storyteller/erdl, /datum/storyteller/mjallidhorn, /datum/storyteller/gani, /datum/storyteller/golerkanh)
