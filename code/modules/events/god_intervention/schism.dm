...
/datum/round_event_control/schism_within_ten
	...
	allowed_storytellers = list(/datum/storyteller/akan, /datum/storyteller/ravox, /datum/storyteller/necra, /datum/storyteller/xylix, /datum/storyteller/pestra, /datum/storyteller/mjallidhorn, /datum/storyteller/gani, /datum/storyteller/malum)
