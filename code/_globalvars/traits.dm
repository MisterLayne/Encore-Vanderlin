...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"Eyes of Deceivers" = TRAIT_MATTHIOS_EYES,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_ASSASSIN = "My soul has been tainted by Archdevil, god of murder.",
	...
	TRAIT_CABAL_CHUD = span_purple("In secret, I have studied the ways of the Jealous God, and know of others of the cult."),
