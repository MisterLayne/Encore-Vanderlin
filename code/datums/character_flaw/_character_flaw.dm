...
/datum/charflaw/lux_taken
	name = "Lux-less"
	desc = "Through some grand misfortune, or heroic sacrifice- you have given up your link to Angros, and with it- your soul. A putrid, horrid thing, you cosign yourself to an eternity of nil after death. Perhaps you are fine with this. \
