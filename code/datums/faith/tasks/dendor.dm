...
/datum/devotion_task/gani_harvest
	...
	desc = "Harvest crops blessed by Gani"
	devotion_reward = 2
	progression_reward = 2
	cooldown_time = 0 SECONDS
	signal_type = COMSIG_PLANT_HARVESTED

/datum/devotion_task/gani_harvest/can_complete(mob/living/carbon/human/user)
	. = ..()
	if(prob(30))
		return TRUE
	return FALSE
...
/datum/devotion_task/gani_tend/can_complete(mob/living/carbon/human/user)
	. = ..()
	if(prob(80))
		return TRUE
	return FALSE
...
/datum/devotion_task/gani_bless
	name = "Provide Gani's Blessing"
	desc = "Spread Gani's word to plants"
	devotion_reward = 25
