...
/obj/effect/decal/cleanable/roguerune/arcyne/summoning/max	//224x224 rune t3(7x7 tile)
	...
	desc = "A thoroughly-warded confinement matrix improved with a Akan's eye sealing measure and the addition of a sealate matrix; used to hold the largest, most dangerous things summonable."
