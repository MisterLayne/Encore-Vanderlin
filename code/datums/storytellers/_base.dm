...
/// Lower follower modifier for special storytellers such as Visires, who is a default patron
...
/// Lower follower modifier for special inhumen storytellers such as One Envy, who gets extra undead followers
