...
/obj/item/statue/silver/finger
	name = "silver hand"
	desc = "A silver statue of a humen hand flashing a common fool's slight. This offensive item has no value."
	icon = 'icons/roguetown/items/precious_objects.dmi'
...
/obj/item/statue/gold/finger
	name = "golden hand"
	desc = "A golden statue of a humen hand flashing a common fool's slight. This offensive item has a measly value."
	icon = 'icons/roguetown/items/precious_objects.dmi'
