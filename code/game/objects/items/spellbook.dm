...
/obj/item/book/granter/spellbook
	...
	"Magick is to be kept close, a guarded secret. Akan changed the rules again. I need to catch up...",
	"Didn’t I just read this page...?",
	"A lone illustration of Akan’s visage fills this page, his stony gaze boring into my soul...",
...
/obj/item/book/granter/spellbook/on_reading_finished(mob/user)
	...
	span_notice("Akan blesses me. I have been granted knowledge and wisdom beyond my years, this tome's mysteries unveiled one at a time."))
