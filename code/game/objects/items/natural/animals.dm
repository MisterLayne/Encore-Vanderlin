...
/obj/item/natural/hide
	name = "hide"
	icon_state = "hide"
	desc = "Hide from one of Gani's creachers."
	dropshrink = 0.90
	force = 0
	throwforce = 0
...
/obj/item/natural/cured/essence
	...
	icon_state = "wessence"
	desc = "A mystical essence imbued with the power of Gani. Merely holding it transports one's mind to ancient times."
	resistance_flags = FLAMMABLE
	w_class = WEIGHT_CLASS_SMALL
	sellprice = 20
...
/obj/item/natural/fur // a piece of skin with animal hair on it. Could be called a fur but its untanned and also encompasses rat skins and goat skins so pelt is more suitable at least to my ears.
	name = "fur"
	icon_state = "wool1"
	desc = "Pelt from one of Gani's creachers."
	dropshrink = 0.90
	force = 0
	throwforce = 0
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/natural/fur/direbear
	desc = "fur from one of Gani's mightiest creachers."
