...
/obj/item/caparison/dunmoon
	name = "Dunnish caparison"
	desc = "A decorative piece of cloth meant to be used as a saddle decoration. It's adorned with the colours of Dunmoon. This one fits on a Saiga."
