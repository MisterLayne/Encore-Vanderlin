/datum/objective/personal/inhumen_scorn
	name = "Scorn Inhumen"
	category = "Visires' Chosen"
	triumph_count = 2
	rewards = list("2 Triumphs", "Visires grows stronger", "Ability to silence inhumen")
	var/spits_done = 0
...
/datum/objective/personal/inhumen_scorn/update_explanation_text()
	explanation_text = "Spit on [spits_required] inhumen to gain Visires' approval!"
