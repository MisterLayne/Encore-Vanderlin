...
GLOBAL_LIST_INIT(accent_list, list(
	...
	ACCENT_STERKENSTADT = strings("accents/grenz_replacement.json", "grenz"),
	...
	ACCENT_NOMAN = strings("accents/wintermare_replacement.json", "wintermare"),
	ACCENT_NORTIC = strings("accents/ossland_replacement.json", "ossland"),
))
