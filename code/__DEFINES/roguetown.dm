#define ALL_TEMPLE_PATRONS 		list(/datum/patron/divine/visires, /datum/patron/divine/akan, /datum/patron/divine/gani, /datum/patron/divine/mjallidhorn, /datum/patron/divine/necra, /datum/patron/divine/ravox, /datum/patron/divine/iliope, /datum/patron/divine/erdl, /datum/patron/divine/malum, /datum/patron/divine/pomette)
...
#define ALL_CLERIC_PATRONS 		list(/datum/patron/divine/visires, /datum/patron/divine/akan, /datum/patron/divine/gani, /datum/patron/divine/mjallidhorn, /datum/patron/divine/necra, /datum/patron/divine/ravox, /datum/patron/divine/iliope, /datum/patron/divine/erdl, /datum/patron/divine/malum, /datum/patron/divine/pomette)
#define ALL_PALADIN_PATRONS 	list(/datum/patron/psydon, /datum/patron/psydon/extremist, /datum/patron/divine/visires, /datum/patron/divine/akan, /datum/patron/divine/gani, /datum/patron/divine/mjallidhorn, /datum/patron/divine/necra, /datum/patron/divine/ravox, /datum/patron/divine/iliope, /datum/patron/divine/erdl, /datum/patron/divine/malum, /datum/patron/divine/pomette)
#define ALL_TEMPLAR_PATRONS 	list(/datum/patron/divine/visires, /datum/patron/divine/akan, /datum/patron/divine/pomette, /datum/patron/divine/necra, /datum/patron/divine/ravox, /datum/patron/divine/erdl, /datum/patron/divine/gani, /datum/patron/divine/mjallidhorn, /datum/patron/divine/malum, /datum/patron/divine/iliope)
...
#define COLORFUL_PATRONS		list("Psydon", "Visires", "Akan", "Gani", "Mjallidhorn", "Necra", "Ravox", "Iliope", "Erdl", "Malum", "Pomette", "Graggar", "Zizo", "Matthios", "Baotha", "The Great Hunt", "The Black Briar")
#define TEMPLE_PATRON_NAMES		list("Visires", "Akan", "Gani", "Mjallidhorn", "Necra", "Ravox", "Iliope", "Erdl", "Malum", "Pomette")
