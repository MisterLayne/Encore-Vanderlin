...
#define COLORFUL_PATRONS		list("Psydon", "Visires", "Akan", "Gani", "Mjallidhorn", "Necra", "Ravox", "Iliope", "Erdl", "Goler Kanh", "Pomette", "Graggar", "Zizo", "Matthios", "Hertannea", "The Great Hunt", "The Black Briar")
#define TEMPLE_PATRON_NAMES		list("Visires", "Akan", "Gani", "Mjallidhorn", "Necra", "Ravox", "Iliope", "Erdl", "Goler Kanh", "Pomette")
