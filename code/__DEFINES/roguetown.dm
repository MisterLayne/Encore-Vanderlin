...
#define COLORFUL_PATRONS		list("Psydon", "Visires", "Akan", "Gani", "Mjallidhorn", "Necra", "Ravox", "Iliope", "Erdl", "Goler Kanh", "Pomette", "Graggar", "Zizo", "Matthios", "Baotha", "The Great Hunt", "The Black Briar")
