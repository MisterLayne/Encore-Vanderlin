...
#define NECROPOLIS_MOBS_TRIVIAL list(/mob/living/simple_animal/hostile/retaliate/scrabbler = 15, /obj/item/reagent_containers/food/snacks/smallrat = 20, /mob/living/simple_animal/hostile/retaliate/bigrat = 15)
#define NECROPOLIS_MOBS_EASY list(/mob/living/simple_animal/hostile/retaliate/scrabbler = 15, /mob/living/carbon/human/species/goblin/npc/cave = 30, /mob/living/simple_animal/hostile/retaliate/bogbug = 20, /mob/living/simple_animal/hostile/retaliate/spider = 15)
...
#define NECROPOLIS_MOBS_ANIMALS_SMALL list(/mob/living/simple_animal/hostile/retaliate/scrabbler = 15, /mob/living/simple_animal/hostile/retaliate/raccoon = 30, /mob/living/simple_animal/hostile/retaliate/bigrat = 30, /mob/living/simple_animal/hostile/retaliate/bobcat = 30, /mob/living/simple_animal/hostile/retaliate/bogbug = 30, /mob/living/simple_animal/hostile/retaliate/fox = 30, /mob/living/simple_animal/hostile/retaliate/bat = 30, /mob/living/simple_animal/hostile/retaliate/frog = 30)
